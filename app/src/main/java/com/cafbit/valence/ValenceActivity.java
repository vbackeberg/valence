...
public class ValenceActivity extends Activity implements OnTouchPadEventListener {
    ...
    private ImageButton keyboardButton = null;
    private ToggleButton volumeButton = null;
    private SpecialKey modifier = null;
    private ValenceActivityVolumeDialogFragment volumeDialog = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        keyboardButton = newKeyboardButton();
...
/*
* Not Working
* Cannot transmit Media Keys

        volumeDialog = new ValenceActivityVolumeDialogFragment();

        volumeButton = new ToggleButton(this);
...
//        buttonLayout.addView(volumeButton);
        rightLayout.setGravity(Gravity.RIGHT);
        rightLayout.addView(keyboardButton);
        buttonLayout.addView(rightLayout, LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT);

        layout.addView(touchPadView, new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT, 1));
        layout.addView(buttonLayout, new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT, 0));
    ...
    //Keyboard Button is a toggle Button without Text but with a keyboard icon
    private ImageButton newKeyboardButton() {
        ImageButton button = new ImageButton(this);
        Drawable keyboardDrawable = getDrawable(R.drawable.keyboard);
        button.setLayoutParams(new LayoutParams(modButton.getMinimumWidth(), LayoutParams.MATCH_PARENT));
        button.setImageDrawable(keyboardDrawable);
        button.setFocusable(false);
        button.setFocusableInTouchMode(false);
    ...
    */
    ...
    public void sendKey(RFBKeyEvent rfbKeyEvent) {
        if (isConnected()) {
